...
<div class="content">
          ...
          <div class="block">
            ...
            <div class="block-header block-header-default" style="background:#fff">
                <h6>Album List</h6>
                <div>
                    <?= $this->Html->link(__('<i class="fa fa-plus mr-5"></i> New Album'), ['action' => 'album'], ['class' => 'btn btn-alt-success mr-5 mb-5','escape'=>false]) ?>
                    
                </div>
            </div>
            <div style="margin: 14px 20px;display:none">
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full dataTable no-footer" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php
                        if($product->status == 1){
                            ?><a class="underline" target="_blank" href="<?= $siteoptions['web_url'] ?>/photo/<?= $product->id ?>"><?= $product->id ?></a></td><?php
                        }else{
                            echo $product->id;
                        }
                        ?>    
                        ...
                        <td class="actions">
                            ...
                            <?= $this->Html->link(__('<i class="fa fa-pencil"></i> Edit'), ['action' => 'albumedit', $product->id],['escape'=>false,'class'=>'btn btn-outline-primary mr-5 mb-5 edit-display ed']) ?>
