...
<div class="content">
    ...
    <div class="col-6 col-xl-3">
        <a class="block block-link-shadow text-right" href="<?= $siteoptions['web_url']?>/products">
        <div class="block-content block-content-full clearfix">
            <div class="float-left mt-10 d-none d-sm-block">
            <i class="si si-bag fa-3x text-body-bg-dark"></i>
            </div>
            <div class="font-size-h3 font-w600" data-toggle="countTo" data-speed="1000" data-to="<?= $products?>">0</div>
            <div class="font-size-sm font-w600 text-uppercase text-muted">News</div>
        </div>
        </a>
    </div>
    <div class="col-6 col-xl-3">
        <a class="block block-link-shadow text-right" href="<?= $siteoptions['web_url']?>/tags">
        <div class="block-content block-content-full clearfix">
            <div class="float-left mt-10 d-none d-sm-block">
            <i class="si si-wallet fa-3x text-body-bg-dark"></i>
            </div>
            <div class="font-size-h3 font-w600"><span data-toggle="countTo" data-speed="1000" data-to="<?= $tags?>">0</span></div>
