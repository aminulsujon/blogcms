              ...
              <div class="sticky-content-inner" style="padding-top: 0px; padding-bottom: 1px; position: relative; transform: none;">
                  ...
                  <div class="post--item post--single post--title-largest pd--30-0">
                      ...
                      <div class="post--info" style="border-bottom:1px solid #ddd;padding-bottom:5px">
                        ...
                        <div class="post--content" id="des_cription" style="margin-bottom:20px">
                        <i><?= $product['summary'] ?></i>
                      </div>
                      <?php
                        foreach($product['uploads'] as $photo){
                            if(!empty($photo['imgname'])){
                                $img_id = $photo['id'];
                                $img_name = $photo['imgname'];
                                $img_caption = $photo['caption'];
                            }else{
                                $img_id = "00";
                                $img_name = "photo";
                            ...
                            <div class="post--img" style="margin-top:10px">
                                <figure>
                                    ...
                                    <?php if(!empty($img_caption)){
                                        ?><figurecaption style="display:block;border-bottom:1px solid #ddd;padding:10px 0;color:gray"><?= $img_caption?></figurecaption><?php
                                    } ?>
                                </figure>
                            </div>
                            <?php
