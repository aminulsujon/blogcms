...
<div class="row">
  <div class="col-md-8">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?= $head_url ?>pages/photos">ছবি</a></li>
      <li class="breadcrumb-item">
        <a href="<?= $head_url ?>pages/photos/<?= $product['id'] ?>"><?= $product['title'] ?></a>
      </li>
  ...
  <div class="col-md-4">
    ...
    <div class="bg-ash p-4 mt-4">
      <h2 class="text-center"><a class="h4 color-theme2" href="<?= $head_url ?>pages/photos">ছবি</a></h2>
      <?php 
      if(!empty($products_latest)){
        ...
        foreach ($products_latest as $product) {
          ...
          ?><a class="d-block mt-4" href="<?= $head_url ?>pages/photos/<?= $product['id'] ?>" class="color-theme2"><span class="video-icon-pre">&rtrif;</span> <?= $product['title'] ?></a><?php 
          if($j==5){break;}
          $j++;
        }
