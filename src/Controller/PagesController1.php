...
class PagesController extends AppController
{
    public function initialize(): void
    {
        ...
        $this->Auth->allow(['index','topics','view','cats','news','details','archive','photos','videos','search','page','converter']);
    }
...
# photos
# ============================================ 
    public function __photos($gallery_id = null,$photo_id = null){
        $this->Products = TableRegistry::getTableLocator()->get('Products');
...
if(empty($photos)){
    ...
    Cache::write('photos', $photos, 'oneweek');
        ...
        $this->set(compact('products_lead','products_shirsho','products_top','products_special','videos','settings','photos'));
    }
